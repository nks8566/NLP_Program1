...
for word, count in reader.unigram_counts.most_common(10):
    print(word, count, round(reader.unigram_probs[word], 4))

print("\nMost common bigrams:")
for bigram, count in list(reader.bigram_counts.most_common(10)):
    bigram_str = " ".join(bigram)
    print(bigram_str, count, round(reader.bigram_probs[bigram_str], 4))

if reader.trigram_flag:
    print("\nMost common trigrams:")
    for trigram, count in list(reader.trigram_counts.most_common(10)):
